...
var createRoute = function(req, res){
    ...
    if(req.body.comment && req.body.comment.text.length > 2500) { //the counter isn't quite accurate on the browser (set to 2000), so add a bit of buffer into the validation
